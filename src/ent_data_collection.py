...
folder_name = 'enterprise-attack-pattern' 
           ...
           # mitre_domain = file_json['x_mitre_domains']
            ...
            for ref in file_json['external_references'][1:]:
                if 'url' in ref: # check if source has url 
                    ...
                    filtering = ['microsoft', 'apple', 'github', 'cloud.google', 'ikipedia', 'support.office'\
                        'amazon', 'gitlab', 'capec', 'docker', 'youtube', 'support.google', 'attack.mitre']
...
with open('ent_dataset.json', 'w') as file:
